        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                    <form action=<? if ($position=='mentor') {echo "../dashboard.php";} else{echo "../explore.php";}
                    ?> method="post" id="signup-form" class="signup-form">
                        <div class="form-row">
                            <div class="form-radio">
                                <label for="position">Position</label>
                                <div class="form-flex">
                                    <input type="radio" name="position" value="mentor" id="mentor" checked="checked" />
                                    <label for="mentor">Mentor</label>
                                    <input type="radio" name="position" value="mentee" id="mentee" />
                                    <label for="mentee">Mentee</label>
                                    <input type="radio" name="position" value="both" id="both" />
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-input" name="first_name" id="first_name" value="First name" />
                            </div>
                            <div class="form-group">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-input" name="gender" id="gender" />
                            </div>
                        </div>
                        <div class="form-group">
